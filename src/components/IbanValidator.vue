<template>
  <div class="iban-validator-container">
    <div class="iban-image"></div>
    <div class="iban-validator">
      <h2>Vérifier un IBAN</h2>
      <p>Entrez votre IBAN ici et nous vous indiquerons si son format est valide.</p>
      <input
        v-model="iban"
        @input="validateIBAN"
        ...
        class="iban-input"
      />
      <p v-if="ibanValid === true" class="valid">L'IBAN est valide.</p>
      <p v-if="ibanValid === false" class="invalid">L'IBAN est invalide.</p>
    </div>
  </div>
</template>
...
const ibanLengths = {
  ...
  "FR": 27, "DE": 22, "GR": 27, "IT": 27, "LU": 20, "NL": 18,
};
